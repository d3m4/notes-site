    ...
    return /* @__PURE__ */ u2("div", { class: classNames(displayClass, "recent-notes"), children: [
      ...
      /* @__PURE__ */ u2("ul", { class: "recent-ul", children: pages.slice(0, opts.limit).map((page) => {
        ...
        return /* @__PURE__ */ u2("li", { class: "recent-li", children: /* @__PURE__ */ u2("div", { class: "section", children: [
          /* @__PURE__ */ u2("div", { class: "desc", children: [/* @__PURE__ */ u2("h3", { children: /* @__PURE__ */ u2("a", { href: resolveRelative(slug2, page.slug), class: "internal", children: title }) }), (page.description ?? page.text) && /* @__PURE__ */ u2("small", { class: "excerpt", children: (page.description ?? page.text).replace(/&amp;/g, "&").replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&#39;/g, "'").replace(/&quot;/g, '"') })] }),
